...
Notes from slide:
    ...
    - unordered map - needs <unordered_map> and using std::unordered_map
        - same interface as map
            ...
            so these bounds dont make sense. Elements with keys 1 through
        ...
        - plus: transparent memory implementation
            ...
            - normal iterators for hash table will iterate through hash table.
            unmap.begin() - unmap.end() goes through every element in hash key order.
